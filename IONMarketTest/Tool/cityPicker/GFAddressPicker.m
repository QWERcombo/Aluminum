...
- (void)setBaseView {
    ...
    UIView *selectView = [[UIView alloc] initWithFrame:CGRectMake(0, height - 240, width, 30)];
    selectView.backgroundColor = color;
    UIButton *cancleBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    [cancleBtn setTitle:@"取消" forState:0];
    [cancleBtn setTitleColor:[UIColor Black_WordColor] forState:0];
    cancleBtn.titleLabel.font = FONT_ArialMT(15);
    ...
    [ensureBtn setTitleColor:[UIColor Black_WordColor] forState:0];
    ensureBtn.titleLabel.font = FONT_ArialMT(15);
    ...
    self.pickView = [[UIPickerView alloc] initWithFrame:CGRectMake(0, height - 210, width, 210)];
